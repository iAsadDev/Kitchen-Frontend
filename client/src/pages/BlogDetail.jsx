  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        ...
        const response = await fetch(`https://ecom-server-production-7e4d.up.railway.app/api/blogposts/${id}`);
        ...
        setBlog(data);
        setImgSrc(`https://ecom-server-production-7e4d.up.railway.app/uploads/${data.image}`);
      } catch (err) {
