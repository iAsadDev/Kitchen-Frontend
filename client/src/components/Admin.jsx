...
const API_ENDPOINTS = {
  PRODUCTS: "https://ecom-server-production-7e4d.up.railway.app/api/products",
  ORDERS: "https://ecom-server-production-7e4d.up.railway.app/api/orders",
  BLOG_POSTS: "https://ecom-server-production-7e4d.up.railway.app/api/blogposts",
};
/**
...
const ProductCard = ({ product, onEdit, onDelete }) => (
  <div className="bg-white border rounded-lg shadow hover:shadow-md transition p-4">
    <img
      src={`https://ecom-server-production-7e4d.up.railway.app/uploads/${product.image}`}
      alt={product.title}
...
const BlogPostCard = ({ post, onEdit, onDelete }) => (
  <div className="bg-white border rounded-lg shadow hover:shadow-md transition p-4">
    {post.image && (
      <img
        src={`https://ecom-server-production-7e4d.up.railway.app/uploads/${post.image}`}
        alt={post.title}
        className="w-full h-40 object-cover rounded mb-3"
        loading="lazy" // Add lazy loading for better performance
      />
  ...
  <div className="bg-white border rounded-lg shadow p-4">
    <div className="flex gap-4">
      {order.productId?.image && (
        <img
          src={`https://ecom-server-production-7e4d.up.railway.app/uploads/${order.productId.image}`}
          alt="Ordered Product"
